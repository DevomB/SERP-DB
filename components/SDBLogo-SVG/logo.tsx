...
/*
	* @param Dimensions => Will legit take all CSS style types I think??
	* @param Fill => Need to have the # there as then the color shower will kick in
*/
const SDB_Logo = ({width = "100%" , height = "auto", fill = "#000000"}) => {
